...
public class VPrincipal extends JFrame  {
	...
	public VPrincipal() {
		...
		txtContenido.addKeyListener(new VPrincipalControlador(txtContenido));
		...
		boton1.addActionListener(new VPrincipalControlador(txtContenido));
		panel_botones.add(boton1);
		
		boton2 = new JButton("Dos");
		boton2.setActionCommand("Dos");
		boton2.addActionListener(new VPrincipalControlador(txtContenido));
		panel_botones.add(boton2);
		
		boton3 = new JButton("Tres");
		boton3.setActionCommand("Tres");
		boton3.addActionListener(new VPrincipalControlador(txtContenido));
